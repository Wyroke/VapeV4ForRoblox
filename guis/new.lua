...
local getcustomassets = {
	['newvape/assets/new/guivapev2.png'] = 'rbxassetid://82637944606318',
	...
	['newvape/assets/new/guivape.png'] = 'rbxassetid://82637944606318',
	...
	['newvape/assets/new/vape.png'] = 'rbxassetid://82637944606318',
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/Wyroke/VapeV4ForRoblox/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
